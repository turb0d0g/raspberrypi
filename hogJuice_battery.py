...
# Logging all of the camera's activity to the "hogjuice_camera_log" file. If you want to watch what your camera
...
logging.basicConfig(format="%(asctime)s %(message)s",filename="hogjuice_camera_log",level=logging.DEBUG)
logging.info("HogJuice HogCam started up successfully")
